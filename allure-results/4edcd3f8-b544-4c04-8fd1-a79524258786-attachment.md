...
```
Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, copyfile 'D:\Playwrightscript\amazon-playwright-framework\test-results\.playwright-artifacts-9\traces\8654e2ec8027cd305a9e-8fb2eee200c3d8a3bcbf-retry1.network' -> 'D:\Playwrightscript\amazon-playwright-framework\test-results\.playwright-artifacts-9\traces\8654e2ec8027cd305a9e-8fb2eee200c3d8a3bcbf-retry1-pwnetcopy-1.network'
```
