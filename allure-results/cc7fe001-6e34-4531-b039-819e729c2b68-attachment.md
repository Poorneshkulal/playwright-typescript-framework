...
```
Error: A snapshot doesn't exist at D:\Playwrightscript\amazon-playwright-framework\tests\visual\HomePageVisual.spec.ts-snapshots\internet-home-page-chromium-win32.png, writing actual.
```
