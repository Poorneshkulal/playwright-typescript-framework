...
- Name: regression\Auth.spec.ts >> The Internet - Login Tests >> Failed Login with Wrong Password
- Location: tests\regression\Auth.spec.ts:23:7
...
```
Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'D:\Playwrightscript\amazon-playwright-framework\test-results\.playwright-artifacts-6\traces\8654e2ec8027cd305a9e-68280cda98613f8883d0.trace'
```
